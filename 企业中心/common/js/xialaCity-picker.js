		...
		bind: function() {
			...
			$(document).on('click', (this._mouteclick = function(e) {
				...
				if($target.is('.city-picker-dropdown')) {
					...
					var dropdownBaba = $dropdown.parent().parent().parent().parent().parent();
					if($('.city-picker-span').hasClass("open")){
						
					}else{
						if(dropdownBaba.hasClass("juzhudi")) {
							$("#xianjudiInput").siblings("img").hide();
							$("#xianjudiInput").val($(".juzhudi .city-picker-span > .title > span").text());
						}else if(dropdownBaba.hasClass("hujidi")) {
							$("#hukoudiInput").siblings("img").hide();
							$("#hukoudiInput").val($(".hujidi .city-picker-span > .title > span").text());
						}else if(dropdownBaba.hasClass("qiwanggongzuodi")) {
							$("#qiwanggongzuodiInput").siblings("img").hide();
							$("#qiwanggongzuodiInput").val($(".qiwanggongzuodi .city-picker-span > .title > span").text());
						}
						else if(dropdownBaba.hasClass("titleLeftContent")){
							$(".titleLeftContent ul li a").eq(1).text($(".titleLeftContent .city-picker-span > .title > span").text());
						}
					}
				}
